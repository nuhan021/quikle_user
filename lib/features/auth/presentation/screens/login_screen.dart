...
//     final iconsRow1 = List<ImageProvider>.from(base)..shuffle(Random(1));
//     final iconsRow2 = List<ImageProvider>.from(base)..shuffle(Random(2));
...
//       ),
//       child: Scaffold(
//         // Prevent the scaffold from resizing when the on-screen keyboard appears.
//         // This keeps the UI in place and lets the keyboard overlay the bottom.
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          child: SingleChildScrollView(
            child: Column(
              children: [
                // Section with padding (logo, texts, etc.)
                Padding(
                  padding: EdgeInsets.symmetric(horizontal: 20.w),
                  child: Column(
                    children: [
                ...
                // Full-width marquees, no padding
                IconRowMarquee(
                  images: iconsRow1,
                  speed: 24,
                  offsetSlots: 0.00,
                ...
                // Form section with padding again
                Padding(
                  padding: EdgeInsets.symmetric(horizontal: 20.w),
                  child: Column(
                    children: [
