...
class MainCategoryProductsScreen extends StatelessWidget {
  const MainCategoryProductsScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(MainCategoryProductsController());
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'All ${controller.subcategoryTitle.value}',
                      style: getTextStyle(
                        font: CustomFonts.obviously,
                        fontSize: 20.sp,
                        fontWeight: FontWeight.w600,
                    ...
                    SizedBox(height: 8.h),
                    Text(
                      '${controller.products.length} items available from all subcategories',
                      style: getTextStyle(
                        font: CustomFonts.inter,
                        fontSize: 12.sp,
                        fontWeight: FontWeight.w500,
              ...
              // Subcategory Filters (Optional - show available subcategories)
              if (controller.availableSubcategories.isNotEmpty) ...[
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    padding: EdgeInsets.symmetric(horizontal: 16.w),
                    itemCount:
                        controller.availableSubcategories.length +
                        1, // +1 for "All" option
                    itemBuilder: (context, index) {
                      if (index == 0) {
                        // "All" filter
                        return GestureDetector(
                          onTap: () => controller.filterBySubcategory(null),
                          child: Container(
                      ...
                      final subcategory =
                          controller.availableSubcategories[index - 1];
                      final isSelected =
                          controller.selectedFilter.value == subcategory.id;

                      return GestureDetector(
                        onTap: () =>
                            controller.filterBySubcategory(subcategory.id),
                        child: Container(
                          margin: EdgeInsets.only(right: 8.w),
                          padding: EdgeInsets.symmetric(
                            horizontal: 16.w,
